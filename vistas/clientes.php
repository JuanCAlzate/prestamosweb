...
<div class="content">
  ...
  <div class="d-flex justify-content-between gap-2 mb-3">
    ...
    <form action="../vistas/generar_pdf.php" method="post" target="_blank">
      <button type="submit" class="btn btn-pdf" name="generar_pdf">
        <i class="bi bi-file-earmark-pdf"></i> PDF
      </button>
    </form>
    <form action="../vistas/generar_excel.php" method="post" target="_blank">
  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      foreach ($clientes as $cliente) {
          ...
          echo "<td>";
          echo "<a href='../ajax/eliminar_cliente.php?id={$cliente['idcliente']}' class='btn btn-danger action-btn'><i class='bi bi-trash'></i></a>";
          echo "<a href='#' class='btn btn-primary action-btn' onclick='abrirModalActualizar({$cliente['idcliente']})'><i class='bi bi-pencil'></i></a>";
          echo "</td>";
          echo "</tr>";
      }
      ?>
